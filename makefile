...
run: bin/Client.o bin/clients.o bin/EncoderDecoder.o bin/connectionHandler.o
	g++ bin/Client.o bin/clients.o bin/EncoderDecoder.o bin/connectionHandler.o -o run $(LDFLAGS)
